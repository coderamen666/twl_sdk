...
/*---------------------------------------------------------------------------*
  ...
  Description:  Initializes the VRAM transfer manager.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Clears internal VRAM transfer tasks for the VRAM transfer manager.
...
/*---------------------------------------------------------------------------*
  ...
  Arguments:    type:       The type of the transmission destination
                dstAddr:       transmission destination address
                pSrc:       pointer to the transfer source data
                szByte:       size of the transmission

  Returns:      Registration success or failure (If succeeded, TRUE).
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Gets total size of registered transfer tasks.
