...
/*---------------------------------------------------------------------------*
    ...
    Initializes the NNS_G3dGlb structure.
 *---------------------------------------------------------------------------*/
void
NNS_G3dGlbInit(void)
{
...
/*---------------------------------------------------------------------------*
    ...
    Projection transform matrix is set in current projection matrix.
    In current position coordinate matrix, thing combining camera matrix and world transform matrix are set.
...
NNS_G3dGlbFlushP(void)
{
    ...
    //
    // After processing the command, the mode is POSITION/VECTOR.
    //
}
...
/*---------------------------------------------------------------------------*
    ...
    Reflect content of NNSG3dGlb in the geometry engine.
    In current projection matrix, item combining projection transform matrix and camera matrix is set.
    In current position coordinate matrix, world transform matrix is set.
...
NNS_G3dGlbFlushVP(void)
{
    ...
    // multiply the camera matrix by the projection matrix
...
/*---------------------------------------------------------------------------*
    ...
    Reflect content of NNSG3dGlb in the geometry engine.
    In current projection matrix, item combining projection transform matrix, camera matrix and world transform matrix is set.
...
/*---------------------------------------------------------------------------*
    ...
    Sets Translation of NNS_G3dGlb base matrix (world transform matrix).
 *---------------------------------------------------------------------------*/
void
...
/*---------------------------------------------------------------------------*
    ...
    Sets Scale of NNS_G3dGlb base matrix (world transform matrix).
 *---------------------------------------------------------------------------*/
void
...
/*---------------------------------------------------------------------------*
    ...
    Sets diffuse and ambient of NNS_G3dGlb.
 *---------------------------------------------------------------------------*/
void
