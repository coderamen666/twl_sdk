...
/*---------------------------------------------------------------------------*
  ...
  Description:  Displays NNSG3dResVisAnmSet content in debug output.
                
  Arguments:    pAnmSet:     Structure that gathers visibility animation sets.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Displays NSBVA file content in debug output.
                
  Arguments:    binFile:     Pointer to head of NSBVA file data.
...
NNS_G3dPrintNSBVA(const u8* binFile)
{
    ...
    for ( i = 0; i < numBlocks; ++i )
    {
        ...
        //
        // Generates summary debug output for each type
        //
        tabPlus_();
        switch( blk->kind )
        {
