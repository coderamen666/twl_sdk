...
/*---------------------------------------------------------------------------*
  ...
  Description:  Displays content of NNSG3dResTexSRTAnmSet in debug output.
                
  Arguments:    pTexSRTSet:     The structure that gathers the texture SRT animation sets.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Displays content of SBTA file in debug output.
