...
//
// The contents of this file are only compiled for a debug build or by the converter.
// 
//
...
/*---------------------------------------------------------------------------*
    ...
    Outputs the individual items of texture information.

    Output is ordered to include the texture index and name, the offset, width, height, the format name, how Pltt0 is handled, and the width and height for the original data.
                        ...
                        u32 idx)
{
    ...
    tabPlus_();
    {
        ...
        if (!(srt->flag & NNS_G3D_SRTFLAG_ROT_ZERO))
        {
            ...
            {
                //
                // parse the compressed data and output
                //
                fx16* p = (fx16*)ptr;
...
/*---------------------------------------------------------------------------*
    ...
    Outputs a summary of the individual materials.
 *---------------------------------------------------------------------------*/
void
...
/*---------------------------------------------------------------------------*
    ...
    Displays a summary of the binary file appropriately.
 *---------------------------------------------------------------------------*/
void
