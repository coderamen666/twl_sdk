...
#ifndef SDK_FINALROM
// String for NNSG2dMCAnimationPlayMode
...
// Extended data might comprise several blocks but currently only user externded attribute blocks.
// 
...
void NNS_G2dUnpackNMC( NNSG2dMultiCellDataBank* pMCellData )
{
    ...
    
    {
        ...
        //
        // Restore the extended information pointer. (If there is one...) 
        //
