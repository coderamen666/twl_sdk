...
// function that gets position info for OAMs that comprise the cell
...
//------------------------------------------------------------------------------
// For objects configured for double affine, the interpolation value used when displaying double affine objects is temporarily removed.
// 
//
...
)
{
    ...
    NNS_G2D_NULL_ASSERT( pV );
    {
        ...
        // adjusting the position of OAM for double affine mode
