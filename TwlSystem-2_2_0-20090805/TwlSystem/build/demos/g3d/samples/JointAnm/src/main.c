...
//---------------------------------------------------------------------------
//
// This sample plays a joint animation.
//
// To play back a joint animation, use an NSBCA file converted from an ICA file using g3dcvtr.
// 
//
// Sample Operation
...
//
// HOWTO:
// 1: Load the .nsbca file into main memory.
...
//    In such cases, a separate NNSG3dAnmObj has to be allocated (but the data within the NSBCA file can be shared).
//    
// 
//---------------------------------------------------------------------------
