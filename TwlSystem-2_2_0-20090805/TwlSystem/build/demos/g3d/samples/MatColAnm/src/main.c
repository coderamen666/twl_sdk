...
//---------------------------------------------------------------------------
//
// This sample plays material color animations.
//
// To play back a material color animation, use an NSBMA file converted from an IMA file using g3dcvtr.
// 
//
// Sample Operation
// Repeatedly playback a material color animation.
// A cube is displayed on the screen, and the color of the cube changes.
// 
// HOWTO:
// 1: Load the .nsbma file into main memory.
// 2: Using functions such as NNS_G3dGetAnmByIdx and NNS_G3dGetAnmByName, get a pointer to the joint animation to be played back.
//    
...
//    In such cases, a separate NNSG3dAnmObj has to be allocated (but the data within the NSBMA file can be shared).
//    
//
//---------------------------------------------------------------------------
...
NitroMain(void)
{
    ...
    //
    // Load the material color animation and try to associate it.
    //
    {
