...
//---------------------------------------------------------------------------
//
// Sample of playing visibility animation
//
// To play back a visibility animation, use an NSBVA file converted from an IVA file using g3dcvtr.
// 
//
// Sample Operation
...
//
// HOWTO:
// 1: Load the .nsbva file into main memory.
// 2: Using functions such as NNS_G3dGetAnmByIdx and NNS_G3dGetAnmByName, get a pointer to the visibility animation to be played back.
//    
...
//    In such cases, a separate NNSG3dAnmObj has to be allocated (but the data within the NSBVA file can be shared).
//    
//
//---------------------------------------------------------------------------
