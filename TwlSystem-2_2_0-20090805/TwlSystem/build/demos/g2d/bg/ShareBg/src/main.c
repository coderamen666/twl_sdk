...
//      Displays the background sharing the characters with the color palette.
//
//  Using the Demo
//      None.
// ============================================================================
...
static void BGSetup( void )
{
    ...
    // load bg
    {
        ...
        NNS_G2dBGSetup(
            ...
            pScnData,
        	NULL,                       // The character is not loaded
        	NULL,                       // The color palette is not loaded
            GX_BG_SCRBASE_0x2000,
            GX_BG_CHARBASE_0x08000      // Shares the character with BG0
        );
