...
//      This is a sample of the UTF-16 character string display method.
//
//  Using the Demo
//      None.
// ============================================================================

// Set the characters handled by the render character string functions to Unicode
...
//      This demo shows the use of NNS_G2dFontInitUTF16.
...
static void SampleMain(void)
{
    ...
    NNS_G2dTextCanvasDrawText(&gTextCanvas, 0, 0,
        ...
        L"\x3042\x3044\x3046\x3048\x304A\x6F22\x5B57"       // <- Japanese characters
    );
    // Japanese text can be written in ShiftJIS encoding, but the character coding is denoted for environments that do not support ShiftJIS.
    // 
}
