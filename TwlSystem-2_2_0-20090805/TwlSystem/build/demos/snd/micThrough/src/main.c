...
// Be advised:
//  This sample only works correctly in NITRO mode.
...
//-----------------------------------------------------------------------------
// Sample format
//   If this definition is removed, format becomes 8 bit
#define FORMAT_PCM16
...
//-----------------------------------------------------------------------------
// Sampling buffer cycle period (Corresponds to playback delay time)
#define SAMPLING_TIME     32 /* msec */

//-----------------------------------------------------------------------------
// Channel number for playback
#define CHANNEL_NO 7
