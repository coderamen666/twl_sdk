...
/*---------------------------------------------------------------------------*
  ...
  Description:  Initializes VRAM mutex processing.
...
/*---------------------------------------------------------------------------*
  ...
  Arguments:    bank:       ID bitmap of VRAM for which exclusive lock is to be attempted
...
/*---------------------------------------------------------------------------*
  ...
  Arguments:    bank:       ID bitmap of VRAM for which exclusive lock is to be released
				lockId:     The arbitrary ID specified at locking
