...
#define MATH_CRC16_STANDARD_POLY    0xa001      // Items that carry out bit inversion also invert generator polynomials.
#define MATH_CRC16_STANDARD_INIT    0
#define MATH_CRC16_CCITT_POLY       0x1021
#define MATH_CRC16_CCITT_INIT       0xffff

#define MATH_CRC32_STANDARD_POLY    0xedb88320  // Items that carry out bit inversion also invert generator polynomials.
...
/*---------------------------------------------------------------------------*
  ...
  Arguments:    table: MATHCRC8Table structure.
                poly:  Inverted bit representation of the generator polynomial with the top bit removed.
