...
/*------------------------------------------------------------------*/
/*          Device Identifiers and Default Settings                            */
/*------------------------------------------------------------------*/
/*---------------------------------------------------------------------------*
  ...
  Description:  Specifies the backup device on the NITRO-CTRDG.
                When the backup device is flash memory, the flash ID is read, the flash on the cartridge is identified, its volume and sector size are gotten, the access speed is set, and the corresponding flash access functions are set.
                ...
                This function must be called once before accessing the backup device (including reads).
                ...
                * Be aware that within this function, all interrupts are prohibited for a certain period of time, and the cartridge is locked.
                ...
                In addition, when the arguments CTRDG_BACKUP_TYPE_FLASH_512K or CTRDG_BACKUP_TYPE_FLASH_1M are used, write operations for the device will begin, and if a device different than that of the argument is on the NITRO-CTRDG, be aware that the backup data may be corrupted.
                
                


  Arguments:    type: Type of backup device on the NITRO-CTRDG.
