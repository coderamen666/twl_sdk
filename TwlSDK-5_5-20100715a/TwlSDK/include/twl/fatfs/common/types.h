...
// File handles that can be opened simultaneously (increase this if necessary)
...
// A command buffer is required for both normal and urgent use
#define FATFS_COMMAND_BUFFER_MAX            (FATFS_COMMAND_BUFFER_SIZE * 2)

#define FATFS_INVALID_HANDLE                0

// Result codes for the FATFS library API
