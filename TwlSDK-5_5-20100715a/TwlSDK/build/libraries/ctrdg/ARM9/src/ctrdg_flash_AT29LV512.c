...
const CTRDGiFlashTypePlus AT29LV512_org = {
    CTRDGi_WriteFlashSectorAT,         // Unusable due to DataPolling routines not being transferred
    CTRDGi_EraseFlashChipAT,
    CTRDGi_EraseFlashSectorAT,         // Unusable due to DataPolling routines not being transferred
...
u32 CTRDGi_EraseFlashSectorCoreAT(CTRDGTaskInfo * arg)
{
    ...
    // ** This routine cannot be used alone if the DataPolling routine is not transferred
    //       
