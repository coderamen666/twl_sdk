...
typedef struct
{
    ...
    WMCallbackFunc verboseScanCallback; // Callback that alerts the user of the the raw WMScan notification
    MBFakeCompareGGIDCallbackFunc compareGGIDCallback; // User-defined GGID comparison callback
    u8      _padding2[8];
}
MBFakeWork;
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Termination function for the fake multiboot child.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Gets the work size necessary for the fake child library.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Sets the MP parent's GGID comparison callback.

  Arguments:    callback    The GGID comparison callback function
...
static void MBFi_StateOutStartScanParent(void *arg)
{
    ...
    case WM_STATECODE_PARENT_FOUND:
        ...
        {
            /*
             * Make a target for beacon parsing if the specified GGID matches or the user-defined comparison is returned as TRUE.
             * 
             * 
             */
...
/*---------------------------------------------------------------------------*
  ...
  Arguments:    index   Gives internal control number of the parent for the entry as an argument.
                        For this argument, you should pass the "index" obtained with the MB_FakeStartScanParent callback.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Gets the game information of the parent from the parent list

  Arguments:    index           Parent index
                pGameInfo Pointer to the region that gets the parent information
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Gets the BssDesc of the parent from the parent list.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Gets the information for WM_StartConnect function based on the parent BssDesc of the parent list.
