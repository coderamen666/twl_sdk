...
/*---------------------------------------------------------------------------*
  ...
  Description: Performs streaming decompression of run-length compressed data.
...
/*---------------------------------------------------------------------------*
  ...
  Description: Performs streaming decompression of run-length compressed data.
                Data is written in 16-bit units. Data can be directly uncompressed to VRAM, but this is slower than MI_ReadUncompRL8.
...
/*---------------------------------------------------------------------------*
  ...
  Description: Performs streaming decompression of LZ-compressed data.
                Data is written in units of 8 bits. Data cannot be directly uncompressed to VRAM.
...
/*---------------------------------------------------------------------------*
  ...
  Description: Performs streaming uncompression of LZ compressed data.
                Data is written in 16-bit units. Data can be directly uncompressed to VRAM, as well, but this is slower than MI_ReadUncompLZ8.
...
/*---------------------------------------------------------------------------*
  ...
  Description: Performs streaming decompression of Huffman-compressed data.
...
//---- End limitation of processor mode
