...
/*---------------------------------------------------------
 Read ELF header
    ...
    buf: Address of ELF header
    ehdr: Buffer for writing read data
 --------------------------------------------------------*/
...
/*---------------------------------------------------------
 Symbol Table Entry Load
    buf: Pointer to buffer to load the symbol entry
    sym: Header address of load source symbol entry
 --------------------------------------------------------*/
...
/*---------------------------------------------------------
 Section Header Load
    buf: Pointer to buffer to load the section header
    shdr: Starting address of load source section header
 --------------------------------------------------------*/
