...
/*---------------------------------------------------------------------------*
  ...
  Description:  Get an unused thread id.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Insert a thread into a thread queue.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Remove the head thread from a thread queue.

  Arguments:    queue  : Thread queue.

  Returns:      Thread pointer that was removed.
 *---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Remove the specified thread from a thread queue.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Removes mutex from mutex queue.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Search for a free thread entry area.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Insert a thread into the thread list, which is arranged by priority.

  Arguments:    Pointer to a thread.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Remove a thread from the thread list.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Switch to the runnable thread with the highest priority.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Initialize the thread system.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Checks if thread system is available.
...
#ifdef  SDK_THREAD_INFINITY
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// OSi_ExitThread that takes the destructor stack into account.
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
// Called when destroying the current thread from OS_DestroyThread.
// Be sure to call with interrupts disabled.
static void OSi_ExitThread_Destroy(void)
{
    OSThread *currentThread = OSi_GetCurrentThread();
    ...
    //---- Release all the mutexes locked by the current thread
    ...
    //---- wakeup threads that are waiting for the currentThread to terminate
#ifndef SDK_THREAD_INFINITY
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Destroys specified thread.
...
void OS_DestroyThread(OSThread *thread)
{
    ...
    //---- Release all the mutexes locked by the specified thread
    ...
    //---- wake up the thread that is waiting for this thread to terminate
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Switches PC to thread destructor to finalize thread.
...
static inline void OSi_KillThreadWithPriority(OSThread *thread, void *arg, u32 prio)
{
    ...
    thread->context.r[0] = (u32)arg;
    thread->context.cpsr |= HW_PSR_IRQ_DISABLE; // prohibit IRQ interrupts within the destructor
...
/*---------------------------------------------------------------------------*
  ...
  Arguments:    thread : Thread for which to cancel the alarm.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Waits for specified thread to terminated.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Checks thread status whether it's terminated.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Gets threads out of sleep status.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Gets threads out of sleep status directly.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Select the runnable thread with the highest priority.

  Arguments:    None.

  Returns:      Pointer to the thread that must run.
                NULL if there is no thread candidate to run.
 *---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Does thread rescheduling. Current thread relinquish CPU
...
void OS_YieldThread(void)
{
    ...
    //---- no thread with the same priority as the current one  or  do not need to arrange list
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Dump the thread list.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Get the number of threads that exist in the system.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Checks thread stack. Check each CheckNUM.
                Return result.
...
/*---------------------------------------------------------------------------*
  ...
  Arguments:    file:     Filename displayed when stack overflows.
                line:     Line number displayed when stack overflows.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Get the system mode stack pointer at svc/irq mode.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Get the current mode stack pointer.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Sets warning level for stack checker.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Changes priority of thread.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Gets priority of thread.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Sets callback called at switching thread.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Procedure of idle thread that system creates.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Get a pointer to the idle thread structure.

  Arguments:    None.

  Returns:      Pointer to the idle thread structure.
 *---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Disables scheduler.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Gets pointer to thread whose id is specified.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Sets thread destructor, which is called when that thread exits.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Gets thread destructor which is set.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Sets user parameter which is allowed to use freely.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Gets user parameter which is set.

  Arguments:    thread : thread pointer

  Returns:      user parameter that is set
 *---------------------------------------------------------------------------*/
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Sets system error number.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Gets system error number.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Checks if the specified thread is in the thread list.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Specifies stack area to call thread destructor.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Stores thread resources to specified pointer.

  Arguments:    resource       Pointer storing thread resources
