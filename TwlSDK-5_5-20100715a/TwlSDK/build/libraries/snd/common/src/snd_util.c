...
/*---------------------------------------------------------------------------*
  ...
  Arguments:    base_timer: Baseline timer value
                pitch: Pitch by which to convert
...
/*---------------------------------------------------------------------------*
  ...
  Description:  From a decibel value, finds the volume level to be set in the channel register.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  References sin table values.

  Arguments:    index: Table index
