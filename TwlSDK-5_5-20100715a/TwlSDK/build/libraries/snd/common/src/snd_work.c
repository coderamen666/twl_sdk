...
/*---------------------------------------------------------------------------*
  ...
  Description:  Performs address conversion.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Gets the player's tick counter.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Gets the sequence local variables.
...
/*---------------------------------------------------------------------------*
  ...
  Arguments:    driverInfo - Driver information structure
                chNo - Channel number
                chInfo - Channel information structure that stores the obtained information
...
/*---------------------------------------------------------------------------*
  ...
  Arguments:    driverInfo - Driver information structure
                ...
                playerInfo - Player information structure that stores the obtained information
...
/*---------------------------------------------------------------------------*
  ...
  Arguments:    driverInfo - Driver information structure
                ...
                trackInfo - Track information structure that stores the obtained information
