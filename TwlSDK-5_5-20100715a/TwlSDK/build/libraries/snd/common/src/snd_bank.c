...
/*---------------------------------------------------------------------------*
  ...
  Description:  Gets instrument parameters from bank (ThreadSafe).
...
BOOL SND_ReadInstData(const SNDBankData *bank, int prgNo, int key, SNDInstData *inst)
{
    ...
    // Process for each instrument type
    switch (inst->type)
    {
    case SND_INST_PCM:
    case SND_INST_PSG:
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Writes instrument data (ThreadSafe).
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Gets SNDInstPos for instrument data scanning.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Gets the next instrument data.

  Arguments:    bank - Pointer to bank data
                inst - Pointer that stores the obtained instrument data
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Registers waveform data to the waveform archive.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  Gets the waveform data registered in the waveform archive.

  Arguments:    waveArc - Pointer to the waveform archive
                index - Index number of waveform data

  Returns:      Pointer to the obtained waveform data.
 *---------------------------------------------------------------------------*/
