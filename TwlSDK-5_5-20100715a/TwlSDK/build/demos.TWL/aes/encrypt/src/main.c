...
static BOOL SampleMain(void)
{
    ...
    // The encrypted data will increase in size by exactly the amount of AES_ENCRYPT_HEADER_SIZE.
    ...
    // Encryption
    {
        ...
        aesResult = AES_Encrypt( pPlainText,         // Data to be encrypted
    ...
    // Decryption
    {
        // Performs decryption in AES CTR Mode
        aesResult = AES_Decrypt( pEncrypted,         // Data to be decrypted
