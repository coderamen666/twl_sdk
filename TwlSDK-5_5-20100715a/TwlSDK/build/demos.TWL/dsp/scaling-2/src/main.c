...
/*---------------------------------------------------------------------------
 This demo enlarges (or shrinks) 640x480 image data to fit a specified size area.
 ...
 - Other Notes
     -- To change the post-scaling size, modify OUTPUT_WIDTH and OUTPUT_HEIGHT and rebuild the demo.
...
/* Settings */
#define RUN_ASYNC     1            // Whether to scale asynchronously
#define USE_FX32      1            // This is 1 when using the fx32 version of DSP_Scaling
...
#define OUTPUT_WIDTH  HW_LCD_WIDTH  // Resolution after processing
...
{
    // Get the scale ratio for input to the DSP_Scaling function from the desired output size
#if USE_FX32
    fx32 factx, facty;
