...
/* Added from NITRO-SDK 3.1 RC (before that, is always 1) */
...
/*---------------------------------------------------------------------------*
  ...
  Arguments:    ggid    Game group ID to configure
...
/*---------------------------------------------------------------------------*
  ...
  Arguments:    callback   Sets the callback returned when the parent device is found
                ...
                channel    Channel on which to search for the parent.
...
/* ----------------------------------------------------------------------
  ...
  Arguments:   mode      If WH_CONNECTMODE_MP_PARENT, MP starts as a parent.
               ...
               tgid      Parent device communications tgid
               channel   Parent device communications channel
