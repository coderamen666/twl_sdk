...
/*---------------------------------------------------------------------------*
  ...
  Description:  Gets connecting device list.

  Arguments:    deviceList: Pointer of list
                deviceMax: Max number of list

  Returns:      -1 if FAIL
                >=0 value is num of device that is connected
 *---------------------------------------------------------------------------*/
