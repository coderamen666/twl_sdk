...
// 1.13  Fixed print callback bug
// 1.12 Corrected help display
// 1.11 Deleted device type
// 1.10 Displayed latest time stamp of source file
...
// 1.6 Disabled buffering of standard output
