...
/*------------------------------------------------------
  Special section (table that supports section numbers before and after stripdebug)
 -----------------------------------------------------*/
...
typedef struct {
  ...
  u32          loaded_size;
  Elf32_Shdr   Shdr;
  char*        str;            /*A copy of the section name string*/
  u32*         sym_table;      /*Table that is valid for a symbol section, containing old and new values*/
  void*        str_table;      /*New string table that is valid for a STR section*/
  u32          str_table_size; /*Size of the new string table that is valid for a STR section*/
}ELShdrEx;
