...
/* When you want to make static inline into inline and reduce the code size, change the macro SDK_INLINE.
   ...
   However, using a version of the compiler in which the inline function materialization bug has been fixed, code size can be reduced if this macro is used to change static inline to inline only in functions where static was changed to static inline to avoid the bug
