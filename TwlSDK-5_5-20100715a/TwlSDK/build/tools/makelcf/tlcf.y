...
%token	<string>	tIF_STATIC_FORCE_FIRST
%token	<string>	tIF_STATIC_FORCE_LAST
...
%token	<string>	tIF_AUTOLOAD_FORCE_FIRST
%token	<string>	tIF_AUTOLOAD_FORCE_LAST
...
%token	<string>	tIF_OVERLAY_FORCE_FIRST
%token	<string>	tIF_OVERLAY_FORCE_LAST
...
token		: tSTRING			{ if (!StoreToken( tSTRING,                $1   )) YYABORT; }
		...
		| tIF_STATIC_FORCE_FIRST		{ if (!StoreToken( tIF_STATIC_FORCE_FIRST, $1 )) YYABORT; }
		| tIF_STATIC_FORCE_LAST			{ if (!StoreToken( tIF_STATIC_FORCE_LAST,  $1 )) YYABORT; }
		...
		| tIF_AUTOLOAD_FIRST             { if (!StoreToken( tIF_AUTOLOAD_FIRST,              $1 )) YYABORT; }
		...
		| tIF_AUTOLOAD_FORCE_FIRST		 { if (!StoreToken( tIF_AUTOLOAD_FORCE_FIRST, $1 )) YYABORT; }
		| tIF_AUTOLOAD_FORCE_LAST		 { if (!StoreToken( tIF_AUTOLOAD_FORCE_LAST,  $1 )) YYABORT; }
		...
		| tIF_OVERLAY_FORCE_FIRST		{ if (!StoreToken( tIF_OVERLAY_FORCE_FIRST, $1 )) YYABORT; }
		| tIF_OVERLAY_FORCE_LAST		{ if (!StoreToken( tIF_OVERLAY_FORCE_LAST,  $1 )) YYABORT; }
