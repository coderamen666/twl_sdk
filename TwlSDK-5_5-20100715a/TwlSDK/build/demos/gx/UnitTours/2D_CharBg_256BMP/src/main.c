...
//---------------------------------------------------------------------------
// A sample that uses 256 color BITMAP BG:
// 
// This sample draws a picture on the display with 256 color palette BITMAP BG
// 
// 
// USAGE:
...
// 3. Set 256 color BITMAP mode with G2_SetBGxControl256Bmp
//---------------------------------------------------------------------------
...
//  Description:
//  Performs an affine transformation (rotation / scale) on a 256-color bitmap BG and then displays it
//      
//
//        1. Use BG surface 3 with BGMODE number 3
//        2. Configure settings with G2_SetBG3Control256Bmp and transfer character data to the specified location
//         
...
#endif
{
    ...
    while (1)
    {
        ...
        /* Set BG3 to a screen size of 256x256 dots and a 256-color bitmapB */
        {
            ...
            // Set BG3 to the 256-color bitmap BG
