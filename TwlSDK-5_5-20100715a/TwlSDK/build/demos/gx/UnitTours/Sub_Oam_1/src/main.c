...
//---------------------------------------------------------------------------
// A sample that displays a sphere using a character OBJ.
//
// HOWTO:
// 1. Transfer object character data with GXS_LoadOBJ
// 2. Transfer object palette data with GXS_LoadOBJPltt
// 3. Specify the attributes for objects with G2S_SetOBJAttr, etc.
// 4. Transfer the copy of object attribute memory with GXS_LoadOAM
//
