...
/*---------------------------------------------------------------------------*
  ...
  Description:  Determines whether it is an SJIS lead byte.
...
/*---------------------------------------------------------------------------*
  ...
  Description:  This is a function that starts the character code.
                Gets the character code of the first character from the byte stream and, at the same time, moves the stream pointer to the next character.
                

  Arguments:    ppChar: The pointer to the buffer where the pointer to the byte array is stored.
                        If returning from a function, the pointer to the beginning of the next character is stored in the buffer indicated by this pointer.
