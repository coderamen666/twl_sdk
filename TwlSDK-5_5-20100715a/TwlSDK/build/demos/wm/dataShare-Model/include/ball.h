...
#define BALL_BUTTON_KEY_RIGHT    0x0010 // +Control Pad, RIGHT
#define BALL_BUTTON_KEY_LEFT     0x0020 // +Control Pad, LEFT
#define BALL_BUTTON_KEY_UP       0x0040 // +Control Pad, UP
#define BALL_BUTTON_KEY_DOWN     0x0080 // +Control Pad, DOWN
...
typedef struct SharedContext
{
    ...
    u8          disabledPlt;    // The palette number when not connected
    u8          connectedPlt;   // The palette number when connected
    u8          ownPlt;         // The palette number used by the local host itself
    u8          padding[1];
}
SharedContext;
...
SDK_INLINE void UpdateBalls(u16 ownAID)
{
    ...
    // Acceleration/deceleration and outer wall collision detection
    for (i = 0; i < BALL_PLAYER_MAX; ++i)
    {
